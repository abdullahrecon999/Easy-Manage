...
import app.controllers.TeacherCon.*;
...
public class TeacherDCon implements Initializable {
    ...
    private void LoadUi(String ui){
        try {
            FXMLLoader loader= new FXMLLoader(getClass().getResource("/app/FXML_Views/Teacher/"+ui+".fxml"));
